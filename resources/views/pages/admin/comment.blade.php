            ...
            <div class="page-inner">
                <div class="page-header">
                    ...
                    <ul class="breadcrumbs">
                        <a href="{{ route('comment.add') }}" class="btn btn-round text-white ml-auto fw-bold" style="background-color: #feb300">
                ...
                <div class="row">
                    @foreach ($DataC as $C)
                    <div class="col-md-4">
                        <div class="card card-annoucement card-round" style="background-color: #feb300">
